...
UCLASS()
class GASEXTENSIONS_API UGASExtAT_WaitCharacterLanded final : public UAbilityTask
{
    GENERATED_BODY()
...
public:
    ...
    static UGASExtAT_WaitCharacterLanded * WaitCharacterLanded( UGameplayAbility * owning_ability, ACharacter * character );
