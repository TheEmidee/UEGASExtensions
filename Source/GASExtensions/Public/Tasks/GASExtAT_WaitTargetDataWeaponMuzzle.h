...
struct GASEXTENSIONS_API FGASExtWaitTargetDataMuzzleOptions
{
...
UCLASS()
class GASEXTENSIONS_API UGASExtAT_WaitTargetDataWeaponMuzzle final : public UGASExtAT_WaitTargetData
{
    GENERATED_BODY()
